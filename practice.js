onload = function () {
    ...
    function createData(){
        start= Math.floor(Math.random() * 17) + 3;
        sz = Math.floor(Math.random() * 20) + 3;
         cities = [
            'Delhi',
            'Mumbai',
            'Jaipur',
        ...
        src = 1;
        console.log(cities[src-1]);
        dst = sz;
        console.log(cities[sz-1]);
        // document.getElementById('text1').innerHTML=`src is ${nodes[src].label} and dest is ${nodes[sz].label}`;
        console.log(`src is ${cities[src-1]} and dest is ${cities[sz-1]}`);
